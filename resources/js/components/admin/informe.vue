                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div id="pestana_empleo_educacion">
                                            ...
                                            <div id="grafica_nivel_academico_sexo" style="height: 900px"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-2"></div>  
                                </div>
    ...
    methods: {
        ...
        generarGraficoNivelAcademicoSexo() {
            ...
            function createSeries(value, name) {
                ...
                bullet.label.numberFormatter = new am4core.NumberFormatter();
                bullet.label.numberFormatter.numberFormat = "#"; 
